<script>
	...
	import Faq from '../../stories/FAQ.svelte';
	import Summary from '../../stories/Summary.svelte';
	import Reassurance from '../../stories/Reassurance.svelte';
	import Schema from '../../stories/Schema.svelte';
	import FullWidthElement from '../../stories/FullWidthElement.svelte';
	import TestingFeatures from '../../stories/TestingFeatures.svelte';

</script>
<Schema></Schema>
<HeroBanner></HeroBanner>
<Writer></Writer>
<div class="container mx-auto px-5 md:px-60">
	<p class="mb-5">
...
<!-- <CompareTable></CompareTable> -->
 <div>
	<h2 class="text-3xl font-bold mb-6 text-center mt-20 md:mb-20">My Selection & Testing Process</h2>

	<TestingFeatures></TestingFeatures>
	<Reassurance></Reassurance>
 </div>
<FullWidthElement></FullWidthElement>
<Faq></Faq>
