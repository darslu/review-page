...
<div class="about-me-container">
    <section class="intro">
        <Avatar src="images/dariaus-profile.jpg" class="rounded-full mb-5" rounded size="xl" />
        <h2 class="text-3xl font-bold">About Me</h2>
        <p class="mt-4 text-lg">
            {@html introText}
        </p>
        <p class="mt-6 font-semibold text-xl">— {name}</p>
    </section>
  
    <section class="experience mt-12">
      <h3 class="text-2xl font-bold">What You Deal With, I Get</h3>
      <p class="mt-4 text-lg">{@html experienceText}</p>
    </section>
  </div>
